      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col items-center gap-8 px-4 sm:px-6 text-center lg:flex-row lg:items-start lg:gap-16 lg:text-left">
        <div className="flex-1">
          ...
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-[#4b3a36] sm:text-lg">
            <strong className="text-[#b30000] font-bold">THIẾT KẾ & THI CÔNG NHÀ ĐẸP - LCK VIỆT</strong> tự hào là người đồng hành đáng tin cậy trên hành trình kiến tạo không gian sống lý tưởng. Chúng tôi quy tụ đội ngũ kiến trúc sư trẻ trung, sáng tạo nhưng dày dạn kinh nghiệm thực tiễn – những con người luôn &ldquo;<strong className="text-[#b30000] font-bold">thiện chiến</strong>&rdquo; trong từng dự án, sẵn sàng chinh phục mọi thách thức để mang đến các công trình mang giá trị bền vững và thẩm mỹ vượt thời gian.
          </p>
          <p className="mt-4 max-w-3xl text-base leading-relaxed text-[#4b3a36] sm:text-lg">
